...
export default async function ThinkerProfilePage({
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Thinkers", item: `${SITE_URL}/thinkers` },
      { "@type": "ListItem", position: 3, name: thinker.name, item: `${SITE_URL}/thinkers/${id}` },
    ],
  };
